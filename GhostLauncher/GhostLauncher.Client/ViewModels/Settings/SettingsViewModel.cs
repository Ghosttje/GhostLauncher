...
namespace GhostLauncher.Client.ViewModels.Settings
{
    public class SettingsViewModel : BaseViewModel
    {
        ...
        private readonly BaseWindowViewModel _windowViewModel;
        ...
        public SettingsViewModel(BaseWindowViewModel windowViewModel, string settingName = null)
        {
